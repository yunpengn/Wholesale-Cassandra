...
public class CqlQueryList {
  ...
  public static final String UPDATE_CUSTOMER_INFO
          = "UPDATE customer_w SET C_BALANCE=%f, C_YTD_PAYMENT=%f, C_PAYMENT_CNT=%d WHERE C_W_ID=%d AND C_D_ID=%d AND C_ID=%d";
  public static final String GET_CUSTOMER_WRITE_INFO
          = "SELECT C_BALANCE, C_YTD_PAYMENT, C_PAYMENT_CNT FROM customer_w WHERE C_W_ID=%d AND C_D_ID=%d AND C_ID=%d";
}
