...
public class PaymentTransaction extends BaseTransaction {
  ...
  @Override public void execute(final String[] dataLines) {
    ...
    executeQuery(
        String.format(CqlQueryList.UPDATE_WAREHOUSE_YTD, warehouse_ytd + payment_amount, customer_warehouse_id));
    ...
    executeQuery(String.format(CqlQueryList.UPDATE_DISTRICT_YTD,
        ScalingParameters.toDB(payment_amount, ScalingParameters.SCALE_D_YTD), customer_warehouse_id,
    ...
    executeQuery(
        String.format(CqlQueryList.UPDATE_CUSTOMER_INFO, balance - payment_amount, ytd_payment + payment_amount,
            payment_cnt + 1,
    ...
    System.out.println(String.format(
        ...
        customer_warehouse_id, customer_district_id, customer_id, customer_info.getString("C_FIRST"),
        customer_info.getString("C_MIDDLE"), customer_info.getString("C_LAST"),
        ...
        formatter.format(Date.from(customer_info.getInstant("C_SINCE"))), customer_info.getString("C_CREDIT"),
        customer_info.getBigDecimal("C_CREDIT_LIM").doubleValue(),
    ...
    System.out.println(String.format("2. Warehouse: %s, %s, %s, %s, %s",
        warehouse_info.getString("W_STREET_1"), warehouse_info.getString("W_STREET_2"),
        warehouse_info.getString("W_CITY"), warehouse_info.getString("W_STATE"), warehouse_info.getString("W_ZIP")));

    System.out.println(String.format("3. District: %s, %s, %s, %s, %s",
        district_info.getString("D_STREET_1"), district_info.getString("D_STREET_2"), district_info.getString("D_CITY"),
        district_info.getString("D_STATE"), district_info.getString("D_ZIP")));
